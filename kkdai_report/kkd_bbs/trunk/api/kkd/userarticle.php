...
if ($_GET['view'] == 'me') {
    ...
    $allowview = true;
    $viewtype = in_array($_GET['type'], ['reply', 'thread', 'postcomment']) ? $_GET['type'] : 'thread';
...
$retCount = C::t('forum_thread')->count_by_authorid($authorid);

$result = [
    'pageId'    => $page,
    'pageCount' => ceil($retCount / $perpage),
    'pageSize'  => $perpage,
    'total' => (int)$retCount
];
...
//                'replyUrl'        => 'http://ikkdbbs.local.com/forum.php?mod=forumdisplay&fid=2',
//            ],
//            [
//                'id'              => 12322,
//                'icon'            => 'http://ibbs.kuaikuaidai.com/static/image/common/forum.gif',
