...
function forum(&$forum) {
    ...
    if(function_exists('getKkdnameByUname')){
        $kkdname = getKkdnameByUname($lastpost['author']);
        $lastpost['kkdname'] = $kkdname?$kkdname:$lastpost['author'];
    }
	...
	if($lastpost['tid']) {
		...
		if($lastpost['author']) {
			$lastpost['author'] = '<a href="home.php?mod=space&username='.rawurlencode($lastpost['author']).'">'.$lastpost['kkdname'].'</a>';
		}
