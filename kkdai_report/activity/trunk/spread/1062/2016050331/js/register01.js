...
$(function(){
	  ...
	  function stepallprocessbar(){
		  stepprocessbar("loading_id_1","processbar_id_1",11500);
		  stepprocessbar("loading_id_2","processbar_id_2",3200);
		  stepprocessbar("loading_id_3","processbar_id_3",2000);
	}
	  function stepprocessbar(loading_id,processbar_id,curMoney) {
...
　　      pb.css({"width":width});
	...
	　　　　setTimeout(function () {
	　　　　　　stepprocessbar(loading_id,processbar_id,curMoney);
	　　　　}, 30);
	　　}else{
