...
';
	...
	public static function btnEditInDatagrid($notice = '修改',$url,$options = [], $ext = '')
	{
		...
		return '<a href="'.$url.'" class="btn btn-green" '
                .'data-options=\''.$str.'\' '
     ...
     * 按组织架构查看
     */
    public static function mb_zzjgck($type = 'single' , $ext = '' , $id = ''){
        return \Prj\Misc\View::btnEditInDatagrid('按组织架构查看',\Sooh\Base\Tools::uri(['type'=>$type,'ext'=>$ext , 'id'=>$id],'index','user','plan'),['width'=>700,'height'=>700]);
    }
}
