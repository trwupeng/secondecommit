...
class MBPerfDailylog extends KVObj
{
     ...
     */
    public static function addData($settime,$staffname,$name, $content, $level, $type, $userid, $logDate, $planCost = 0, $realCost = 0, $finish = 0, $finishReason = '')
    {
        $data = [
            'settime'       => $settime,
            'staffname'     => $staffname,
