...
/**
 *
 * php /var/www/licai_php/public/crond.php "__crond/run&task=RptDaily.EDRealnameAuth&ymdh=20160126"
 * Created by PhpStorm.
 * User: li.lianqi
 * Date: 2016/1/27 0027
 * Time: 下午 3:35
...
//`bid_repay_flow_account` bigint(32) DEFAULT '0' COMMENT '标的还款资金流向,存钱罐账户',
    ...
    protected function oneday($ymd){
        ...
        $yeb_fund_flow_withdraw = \Rpt\EvtDaily\RealnameAuth::getCopy('RealnameAuth');
        $n = $db_p2p->getOne(\Rpt\Tbname::licai_core_data, 'realname_count', ['effect_date'=>$ymd]);
        if ($n>0){
            $yeb_fund_flow_withdraw->add($n, 0, 0, 0);
