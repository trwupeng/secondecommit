...
public class SuperCustomToast {
    ...
    public void initView() {
        ...
        mView.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER);

        View gapView = new View(mContext);
        gapView.setLayoutParams(new LayoutParams(screenWidth, screenHeight / 2));
    ...
    public TextView getTextView(String msg) {
        ...
        setDefaultBackgroundResource(R.drawable.toast_bg);
