...
(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      '</div>' : '';
      var drop =
          '<div class="btn-group bootstrap-select' + multiple + inputGroup + '" style="width: 80%;">' +
          ...
          searchbox +
          actionsbox +
          '<ul class="dropdown-menu inner selectpicker" role="menu" name="' + this.options.name + '">' +
          '</ul>' +
          '</div>' +
          '</div>';
