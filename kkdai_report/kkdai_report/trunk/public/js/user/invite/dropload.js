    ...
    MyDropLoad.prototype.init = function(options){
        ...
        me.opts = $.extend({}, {
            ...
            domDown : {                                                          // 下方DOM
                ...
                domRefresh : '<div class="dropload-refresh dropload-refresh-font">↑上拉加载更多</div>',
                domUpdate  : '<div class="dropload-update dropload-refresh-font">↓释放加载</div>',
                domLoad    : '<div class="dropload-load dropload-refresh-font"><span class="loading"></span>加载中...</div>'
            },
            distance : 50,                                                       // 拉动距离
            loadUpFn : '',                                                       // 上方function
